...
OptionFile::OptionFile()
    : _filename("options.kebb"), _resolution("480-20"), _layout("US"), _nb_targets("5"), _countdown("60"),
      _speed("20"), _letters("1"), _capitals("0"), _numbers("0"), _symbols("0"), _french_extras("0"),
      _french_extra_caps("0") {
