  ...
  _triangle = {
      {
          ...
          kebb::color(kebb::ColorName::C_Sky),
          SDL_FPoint{0},
      },
      {
          SDL_FPoint{0, y_zero},
      ...
      {
          SDL_FPoint{0, 0},
          kebb::color(kebb::ColorName::C_Red),
          SDL_FPoint{0},
      },
  };
}
...
void WidgetGauge::set_text(std::string val) { _textbox_level->set_text(std::move(val)); } // FIX: kepp move ?
